...
const DATA = {
  ...
  events: [
    ...
    {d:"2026-09-30", short:"Pure Math", l:"Extra exam — Pure Math PM", track:"school", hard:true, tz:"local centre"},
    {d:"2026-10-07", short:"Prob Stats", l:"Extra exam — Prob Stats PM", track:"school", hard:true, tz:"local centre"},
    {d:"2026-10-07", short:"Further Pure", l:"Extra exam — Pure Further Maths AM", track:"school", hard:true, tz:"local centre"},
    {d:"2026-10-09", short:"Further Mech", l:"Extra exam — Further Math Mechanics AM", track:"school", hard:true, tz:"local centre"},
  ...
  bands: [
    ...
    {lane:"school", s:"2026-09-30", e:"2026-10-09", l:"Extra exams", freeze:true},
  ...
  plan: [
    ...
    {type:"section", label:"Extra Exams"},
    {type:"task", label:"Pure Math PM", target:"2026-09-30", status:"30 Sep · PM"},
    {type:"task", label:"Prob Stats PM", target:"2026-10-07", status:"7 Oct · PM"},
    {type:"task", label:"Pure Further Maths AM", target:"2026-10-07", status:"7 Oct · AM"},
    {type:"task", label:"Further Math Mechanics AM", target:"2026-10-09", status:"9 Oct · AM"},
  ...
  schools: [
    ...
    {name:"Johns Hopkins", tier:"Reach", loc:"Baltimore, MD", country:"US", mark:"Yes", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"Full need — verify", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Planning"},
    ...
    {name:"Tufts", tier:"Match", loc:"Medford, MA", country:"US", mark:"Yes", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"TBD-VERIFY", aidCat:"private", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Planning"},
    ...
    {name:"Northeastern", tier:"Match", loc:"Boston, MA", country:"US", mark:"Yes", sys:"Common App", ce:3, am:4, tp:"TBD-VERIFY", aid:"Merit likely", aidCat:"merit", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Planning"},
    ...
    {name:"University of Manchester", tier:"Match", loc:"Manchester, England", country:"UK", mark:"Yes", sys:"UCAS", ce:null, am:null, tp:"None — verify", aid:"International fees — no aid", aidCat:"uk", deadline:null, deadlineLabel:"Jan 2027 — PARKED", round:"UCAS", status:"Parked", parked:true},
    ...
    {name:"Princeton", tier:"Reach", loc:"Princeton, NJ", country:"US", mark:"add", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Harvard", tier:"Reach", loc:"Cambridge, MA", country:"US", mark:"add", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Yale", tier:"Reach", loc:"New Haven, CT", country:"US", mark:"add", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Duke", tier:"Reach", loc:"Durham, NC", country:"US", mark:"add", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Brown", tier:"Reach", loc:"Providence, RI", country:"US", mark:"add", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Columbia", tier:"Reach", loc:"New York, NY", country:"US", mark:"add", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"Cornell", tier:"Reach", loc:"Ithaca, NY", country:"US", mark:"add", sys:"Common App", ce:5, am:5, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided", note:"Admits by college"},
    {name:"Dartmouth", tier:"Reach", loc:"Hanover, NH", country:"US", mark:"add", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"University of Virginia", tier:"Match", loc:"Charlottesville, VA", country:"US", mark:"add", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"UNC Chapel Hill", tier:"Match", loc:"Chapel Hill, NC", country:"US", mark:"add", sys:"Common App", ce:3, am:3, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"University of Michigan–Ann Arbor", tier:"Reach", loc:"Ann Arbor, MI", country:"US", mark:"add", sys:"Common App", ce:5, am:5, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided", note:"Admits by college"},
    {name:"Boston University", tier:"Match", loc:"Boston, MA", country:"US", mark:"add", sys:"Common App", ce:3, am:4, tp:"TBD-VERIFY", aid:"TBD-VERIFY", aidCat:"private", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"University of Florida", tier:"Safety", loc:"Gainesville, FL", country:"US", mark:"add", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Undecided"},
    {name:"NYU", tier:"Match", loc:"New York, NY", country:"US", mark:"unsure", sys:"Common App", ce:2, am:2, tp:"TBD-VERIFY", aid:"Does not meet full need", aidCat:"private", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"University of Maryland, College Park", tier:"Match", loc:"College Park, MD", country:"US", mark:"unsure", sys:"Common App", ce:4, am:5, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"University of Notre Dame", tier:"Reach", loc:"Notre Dame, IN", country:"US", mark:"unsure", sys:"Common App", ce:4, am:4, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"University of Wisconsin–Madison", tier:"Match", loc:"Madison, WI", country:"US", mark:"unsure", sys:"Common App", ce:null, am:null, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"Vanderbilt University", tier:"Reach", loc:"Nashville, TN", country:"US", mark:"unsure", sys:"Common App", ce:3, am:null, tp:"TBD-VERIFY", aid:"Full need", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"University of Minnesota Twin Cities", tier:"Safety", loc:"Minneapolis, MN", country:"US", mark:"unsure", sys:"Common App", ce:null, am:null, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"Texas A&M University", tier:"Safety", loc:"College Station, TX", country:"US", mark:"unsure", sys:"Common App", ce:5, am:5, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"University of Washington", tier:"Match", loc:"Seattle, WA", country:"US", mark:"unsure", sys:"Common App", ce:null, am:null, tp:"TBD-VERIFY", aid:"OOS public — likely little", aidCat:"oos", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"Rose-Hulman Institute of Technology", tier:"Safety", loc:"Terre Haute, IN", country:"US", mark:"unsure", sys:"Common App", ce:null, am:null, tp:"TBD-VERIFY", aid:"Merit likely", aidCat:"merit", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Unsure"},
    {name:"Northwestern", tier:"Reach", loc:"listed as Boston, MA", country:"US", mark:"review", sys:"Common App", ce:null, am:null, tp:"TBD-VERIFY", aid:"Full need — verify", aidCat:"full-need", deadline:null, deadlineLabel:"TBD-VERIFY", round:"TBD", status:"Review", note:"OQ-05 — Excel has Amogh blank, Saanvi Yes, location Boston. Northwestern is Evanston, IL."}
  ],
